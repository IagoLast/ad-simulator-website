...
import { ArrowRight, Coins, Gamepad2, Users } from "lucide-react"
      ...
      <header className="border-b border-pixel-border bg-pixel-dark px-4 py-4">
        <div className="container mx-auto flex items-center justify-between">
          ...
          <nav className="hidden space-x-4 md:block">
            <Link href="#features" className="font-pixel text-pixel-green hover:text-pixel-yellow">
              Features
            </Link>
            <Link href="#how-to-play" className="font-pixel text-pixel-green hover:text-pixel-yellow">
              How to Play
            </Link>
            <Link href="#waitlist" className="font-pixel text-pixel-green hover:text-pixel-yellow">
              Join Waitlist
            </Link>
          </nav>
          ...
          <div className="container mx-auto grid gap-8 md:grid-cols-2 md:gap-12">
            <div className="flex flex-col justify-center space-y-6">
              <div className="inline-block rounded bg-pixel-dark px-4 py-1">
                <span className="font-pixel text-sm text-pixel-yellow">COMING SOON</span>
              </div>
              ...
              <p className="max-w-[600px] font-pixel text-lg text-pixel-light-gray">
                A battlefield full of ads. Sponsored weapons, company-paid upgrades. Join matches and win the pot!
              </p>
              <div className="flex flex-col gap-4 sm:flex-row">
                <div className="flex w-full max-w-md gap-2">
                  <Input
                    ...
                    className="h-11 border-2 border-pixel-border bg-pixel-dark font-pixel text-white placeholder:text-pixel-light-gray"
                    required
                  />
                  <Button type="submit" variant="pixel" size="lg">
          ...
          <div className="container mx-auto">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="rounded-lg border-2 border-pixel-border bg-pixel-card p-6 shadow-pixel">
                ...
                <h3 className="mb-2 font-pixel text-xl text-white">Ad Battlefield</h3>
                <p className="font-pixel text-pixel-light-gray">
                  Fight in a world where everything is an advertisement. Use branded weapons and power-ups to dominate.
                </p>
              </div>
              <div className="rounded-lg border-2 border-pixel-border bg-pixel-card p-6 shadow-pixel">
                ...
                <h3 className="mb-2 font-pixel text-xl text-white blink-animation">Win the Pot</h3>
                <p className="font-pixel text-pixel-light-gray">
                  Each match has a prize pool. The last player standing takes it all. Will you be the champion?
                </p>
              </div>
              <div className="rounded-lg border-2 border-pixel-border bg-pixel-card p-6 shadow-pixel">
                ...
                <h3 className="mb-2 font-pixel text-xl text-white">Regular Matches</h3>
                <p className="font-pixel text-pixel-light-gray">
                  New matches are generated periodically. Join the waitlist and get notified when it's time to play.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto">
            ...
            <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="font-pixel text-pixel-light-gray">Join the waitlist to get early access to the game.</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-pixel-dark font-pixel text-2xl text-pixel-green">
                  2
                </div>
                <h3 className="mb-2 font-pixel text-xl text-white">Get Notified</h3>
                <p className="font-pixel text-pixel-light-gray">Receive alerts when new matches are about to start.</p>
              </div>
              <div className="flex flex-col items-center text-center">
                <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-pixel-dark font-pixel text-2xl text-pixel-green">
                  3
                </div>
                <h3 className="mb-2 font-pixel text-xl text-white">Join Battle</h3>
                <p className="font-pixel text-pixel-light-gray">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="mb-2 font-pixel text-xl text-white">Win Rewards</h3>
                <p className="font-pixel text-pixel-light-gray">Be the last one standing and claim the prize pool.</p>
              </div>
            </div>
          </div>
        </section>

        <section id="advertise" className="bg-pixel-dark px-4 py-16 border-y border-pixel-border">
          <div className="container mx-auto">
            <h2 className="mb-6 text-center font-pixel text-3xl text-white md:text-4xl">
              Advertise <span className="text-pixel-yellow blink-animation">Your Brand</span>
            </h2>
            <p className="mb-10 text-center font-pixel text-pixel-light-gray max-w-2xl mx-auto">
              Place your brand in the battlefield. Get your products, services, and logos in front of players as they
              compete for the prize.
            </p>

            <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <div className="rounded-lg border-2 border-pixel-border bg-pixel-card p-6 shadow-pixel">
                <h3 className="mb-4 font-pixel text-2xl text-white">Advertising Options</h3>
              ...
              <div className="rounded-lg border-2 border-pixel-border bg-pixel-card p-6 shadow-pixel">
                <h3 className="mb-4 font-pixel text-2xl text-white">Why Advertise With Us?</h3>
                <div className="space-y-4 font-pixel text-pixel-light-gray">
                  <p>
                    <span className="text-pixel-yellow font-bold">Engagement:</span> Players interact directly with your
                    brand during intense gameplay.
                  </p>
                  <p>
                    <span className="text-pixel-yellow font-bold">Memorability:</span> Your brand becomes part of the
                    game experience, not just another ad.
                  </p>
                  <p>
                    <span className="text-pixel-yellow font-bold">Targeting:</span> Reach gamers who are fully engaged
          ...
          <div className="container mx-auto max-w-3xl">
            <div className="rounded-lg border-2 border-pixel-border bg-pixel-card p-8 shadow-pixel">
              ...
              <p className="mb-8 text-center font-pixel text-pixel-light-gray">
                Be the first to know when AD SIMULATOR launches. Get early access and exclusive in-game items.
              </p>
              <WaitlistForm />
            </div>
          </div>
        ...
        <div className="container mx-auto">
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            <div className="flex items-center gap-2">
              ...
              <span className="font-pixel text-lg text-white">AD SIMULATOR</span>
            </div>
            <div className="flex gap-6">
              <Link href="#" className="font-pixel text-sm text-pixel-light-gray hover:text-pixel-green">
                Privacy Policy
              </Link>
              <Link href="#" className="font-pixel text-sm text-pixel-light-gray hover:text-pixel-green">
                Terms of Service
